...
# REMEDIATION: Public access block enabled (blocks public access)
...
# REMEDIATION: Private ACL (blocks public access)
...
# REMEDIATION: Restricted bucket policy (blocks public write access)
