...
# FIXED: Changed from public-read-write to private to block public write access
...
# FIXED: Removed write actions (PutObject, DeleteObject) to block public write access
...
output "security_warnings" {
  value = "WARNING: This bucket has limited public read access but public write access is blocked. Encryption and versioning are still disabled!"
}
