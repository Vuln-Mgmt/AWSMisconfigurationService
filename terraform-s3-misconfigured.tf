...
# REMEDIATION 1: Public access block enabled (blocks public access)
...
# REMEDIATION 2: Private ACL (blocks public read/write)
...
# REMEDIATION 6: Bucket policy denying public write access
...
output "security_warnings" {
  value = "REMEDIATED: Public write access has been blocked. Encryption and versioning remain disabled for testing purposes."
}
