...
# FIXED: Private ACL (no public access)
...
# FIXED: Removed public bucket policy - no public access allowed
...
output "security_warnings" {
  value = "FIXED: Public access has been blocked. Bucket now has private ACL and public access block enabled. Note: Encryption and versioning are still disabled."
}
