...
# REMEDIATION: Block Public Access settings enabled to prevent public write access
...
# REMEDIATION: Private ACL to prevent public write access
...
# REMEDIATION: Bucket policy with public write access removed
# Note: Public read access still present (other misconfigurations remain)
...
output "security_warnings" {
  value = "WARNING: This bucket still has misconfigurations (no encryption, no versioning). Public write access has been blocked."
}
