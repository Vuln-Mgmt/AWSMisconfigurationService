...
# REMEDIATED: Public access block enabled to prevent public write access
...
# REMEDIATED: Private ACL to block public write access
...
# REMEDIATED: Removed public write access from bucket policy
